...
export function SemanticMapView({ searchQuery, isSemanticMode }: SemanticMapViewProps) {
  const semanticPath = isSemanticMode && searchQuery ? getSemanticPath(searchQuery) : null;

  return (
    <div className="absolute h-[1117px] left-0 overflow-clip top-0 w-full" data-name="Google Maps Widget">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-4 left-4 bg-white rounded-lg shadow-lg border border-gray-200 p-3 max-w-xs">
            <div className="flex items-center gap-2 mb-1">
              ...
              />
              <span className="text-sm font-medium text-gray-900">Semantic Route</span>
            </div>
